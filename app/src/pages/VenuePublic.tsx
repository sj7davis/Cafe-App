...
import { getOpenStatus, cartKey, isWithinHappyHour, renderWebsiteBlocks, type CartItem } from './venue-public/helpers';
import { OrderAgainRow, ModifierModal, SplitBillPanel, MenuCard } from './venue-public/components';
...
export default function VenuePublic() {
  ...
  return (
    <div style={{ background: tBg, fontFamily: `${tFont}, Inter, -apple-system, sans-serif` }}>
      ...
      {Array.isArray((venue as any).websiteBlocks) && (venue as any).websiteBlocks.length > 0 ? (
        renderWebsiteBlocks((venue as any).websiteBlocks, primaryColor, slug || '', allMenuItems, reviewsList || [], accentColor, tBg, tFont, templateId)
      ) : (
        <>
